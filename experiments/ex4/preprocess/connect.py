...
df_y = add_duration_since_20180101(df_y, time_column = time_column_data_dt, result_column=result_column_timestamp)

x_train, x_test, f_train, f_test, y_train, y_test = split_data(df_input, df_feat_input, df_y, window_size = window_size, test_size = test_size)

y_train, y_test, y_columns = add_objam_mean_M3_diff_as_new_target(df_y, y_train, y_test)
